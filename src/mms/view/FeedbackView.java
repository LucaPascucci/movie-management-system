...
import mms.controller.FeedbackController;
...
public class FeedbackView extends AbstractView {
	...
	/** The Constant HALF_VERTICAL_GAP. */
	private static final int HALF_VERTICAL_GAP = 10;
	...
	/** The send. */
	private final JButton send = new JButton("Send", new ImageIcon(this.getClass().getResource("/Send.png")));
	...
	public FeedbackView() {
		...
		this.setTitle("Contact Developers");
